...
data modify entity @e[tag=dies.selected_display,distance=..11,type=minecraft:item_display,limit=1] item.components."minecraft:custom_data".loottable set from entity @s SelectedItem.components."minecraft:entity_data".DeathLootTable
