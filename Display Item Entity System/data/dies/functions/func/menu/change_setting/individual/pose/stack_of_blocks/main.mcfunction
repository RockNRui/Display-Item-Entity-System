...
execute as @e[tag=dies.selected_display,distance=..11,type=minecraft:item_display] at @s run function dies:func/menu/change_setting/individual/pose/stack_of_blocks/as_display
